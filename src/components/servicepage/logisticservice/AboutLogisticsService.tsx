    ...
    <div className="bg-secondary">
      ...
      <div className="bg-bg4 bg-cover no-bg-repeat relative">
        ...
        <div className="relative z-10 py-14 max-w-screen-2xl mx-auto px-5 sm:px-20">
          <div className="mb-7">
            <h3 className="anton-regular text-primary text-8xl mb-6 uppercase">
              PALLETIZING
            </h3>
            <div className="px-8 py-7 border text-white font-kindsans-regular w-[60%]">
          ...
          <div className="">
            <h3 className="anton-regular text-white text-8xl mb-6 uppercase">
