...
const PrivacyPolicy = () => {
  return (
    <div className="bg-black py-32 text-white">
      <div className="max-w-screen-2xl mx-auto px-5 md:px-20 py-5 md:py-20">
        <div>
        ...
        <div className="mt-10">
          <h2 className="anton-regular text-3xl md:text-4xl mb-3 ">Who we are</h2>
          <p className="font-kindsans-regular mb-6">
            Our website address is: https://redtrucking.com.
          </p>
          <h3 className="anton-regular text-3xl md:text-4xl mb-3 ">Comments</h3>
          <p className="font-kindsans-regular mb-6">
            {" "}
          ...
          <h3 className="anton-regular text-3xl md:text-4xl mb-3 ">Media</h3>
          <p className="font-kindsans-regular mb-6">
            {" "}
          ...
          <h3 className="anton-regular text-3xl md:text-4xl mb-3 ">Cookies</h3>
          <p className="font-kindsans-regular mb-6">
            {" "}
          ...
          <h3 className="anton-regular text-3xl md:text-4xl mb-3 ">
          ...
          <p className="font-kindsans-regular mb-6">
            ...
            queue.
            <br /> For users that register on our website (if any), we also
