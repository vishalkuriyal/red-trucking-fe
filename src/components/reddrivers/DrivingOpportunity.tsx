...
const DrivingOpportunity = () => {
  ...
  return (
    <div className="bg-bg1 bg-cover bg-no-repeat">
      ...
      <div className="flex flex-col items-center pb-8 md:pb-28 px-5 md:px-0">
        ...
        <div className="mb-6 md:mb-16">
          <p className="anton-regular text-white md:text-[32px]">
        ...
        <div className="flex gap-4 md:gap-11">
          ...
          >
            <div className="bg-[#1d1d1d] px-4 py-2 md:px-14 md:py-6 flex items-center justify-between gap-7 shadow-[inset_0px_0px_20px] h-full">
              <h4 className="anton-regular md:text-2xl text-white">OWNER OPERATOR</h4>
            </div>
          </Link>
          <Link
            to="/company-driver"
          ...
          >
            <div className="bg-[#1d1d1d] px-4 py-2 md:px-14 md:py-6 flex items-center justify-between gap-7 shadow-[inset_0px_0px_20px] h-full">
              <h4 className="anton-regular md:text-2xl text-white">COMPANY DRIVER</h4>
            </div>
          </Link>
        </div>
      </div>
