  ...
  return (
    <div className="bg-secondary">
      <div className="max-w-screen-2xl mx-auto px-5 md:px-20 relative">
        <h2 className="anton-regular text-[128px] leading-[120px] gradient-stroke-white absolute left-0 -top-10">
          ABOUT US
        </h2>
      </div>
      <div className="flex justify-between max-w-screen-2xl mx-auto px-5 md:px-20 py-8 md:pb-28">
        <div className="w-[45%]">
      ...
      <div className="max-w-screen-2xl mx-auto md:pr-20 flex justify-between pb-8 md:pb-28">
        <div className="w-[45%]">
          <img src={img} className="w-full" alt="" />
        </div>
        <div className="w-[50%] grid gap-5">
          <div className="grid grid-cols-7 gap-5">
            <div className="anton-regular text-xl leading-[32px] col-span-2 flex justify-center items-center bg-[#1B1B1B] text-white">
              TRUST
            </div>
            <div className="col-span-5 px-5 py-6 bg-[#1B1B1B] text-white">
