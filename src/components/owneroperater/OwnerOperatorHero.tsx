import bg from "../../assets/images/ownerOperatorHeroBg.webp";

const OwnerOperatorHero = () => {
  return (
      ...
      <div className="max-w-screen-2xl mx-auto px-5 sm:px-0 md:pl-20 py-8 sm:py-0 md:pt-8">
        <div className="relative">
          <p className="font-kindsans-medium text-white">
            HOME &gt; { " "}
            <span className="text-primary uppercase">owner operator</span>{" "}
          </p>
...
export default OwnerOperatorHero;
